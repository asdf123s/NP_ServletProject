    	...
    	<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-10 btm text-center">
					<ul class="product-category">
						...
						<li><a href="/np/supplies.do" class="active">용품</a></li>
					</ul>
				</div>
			</div>
    			...
    			<div class="col-md-10 btm text-center">
    				<form method="GET" action="supplies.do">
    					<ul class="product-category">
    						...
    						<li><input type="submit" class="nutritionbtn" name="one" value="구강케어"></li>
    						<li><input type="submit" class="nutritionbtn" name="two" value="바디케어"></li>
    						<li><input type="submit" class="nutritionbtn" name="three" value="헤어케어"></li>	
    						<li><input type="submit" class="nutritionbtn" name="four" value="여성용품"></li>
    						<li><input type="submit" class="nutritionbtn" name="five" value="남성용품"></li>
    						<li><input type="submit" class="nutritionbtn" name="six" value="손소독제"></li>
    						<li><input type="submit" class="nutritionbtn" name="seven" value="마음건강"></li>
    					</ul>
    				</form>
    			</div>
    		</div>
    		...
    		<c:if test="${map.isSearch == 'y'}">
    			<div class="searchsize">
    				『 <i class="fa-solid fa-magnifying-glass"></i> <span style="font-weight:900">'${map.word}'</span>(으)로 검색한 결과 총 <span style="font-weight:900">${productListSupplies.size()}</span>개의 상품이 발견되었습니다. 』
    			</div>
			</c:if>

			<div class="row">

				<c:forEach items="${productListSupplies}" var="dto">
